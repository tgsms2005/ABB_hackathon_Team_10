    ...
    <div class="main-container" *ngIf="authService.isLoggedIn()">
      <mat-card class="content-card">
        <mat-tab-group animationDuration="0ms" [(selectedIndex)]="currentStep">
          ...
          <mat-tab label="Upload History">
            <app-upload-history></app-upload-history>
          </mat-tab>
          <mat-tab label="Dataset Summary">
            <app-dataset-summary></app-dataset-summary>
          </mat-tab>
          <mat-tab *ngIf="authService.isAdmin()" label="Admin Dashboard">
...
export class AppComponent {
  ...
  // Add this method
  onLoginSuccess() {
    // After login, update state if needed
  }
}