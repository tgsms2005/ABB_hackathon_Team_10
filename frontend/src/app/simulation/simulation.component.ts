    ...
    <div class="container">
      ...
      <div class="stats-container">
        <mat-card class="stat-card">
          <p class="label"><mat-icon color="primary">analytics</mat-icon> Total Predictions</p>
          <p class="value">{{ stats.total }}</p>
        </mat-card>
        <mat-card class="stat-card">
          <p class="label"><mat-icon color="primary">check_circle</mat-icon> Pass Count</p>
          <p class="value pass-count">{{ stats.pass }}</p>
        </mat-card>
        <mat-card class="stat-card">
          <p class="label"><mat-icon color="warn">cancel</mat-icon> Fail Count</p>
          <p class="value fail-count">{{ stats.fail }}</p>
        </mat-card>
        <mat-card class="stat-card">
          <p class="label"><mat-icon color="accent">percent</mat-icon> Avg Confidence</p>
